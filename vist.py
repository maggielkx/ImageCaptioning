...
class Story_in_Sequence:
    ...
    def read_img(self, img_file):
        ...
        img_content = imresize(img_content, (256, 256))
        return img_content
        ...
        if show_image:
            ...
            for i, sent_id in enumerate(sent_ids):
                ...
                if osp.exists(img_file):
                    ...
                    if i != 1:
                        img_content = np.rot90(img_content, 3)
                    flag = 1
                else:
                    continue
        ...
        for i, img_id in enumerate(img_ids):
            ...
            if osp.exists(img_file):
                ...
                if i == 0 or i==8 or i== 10 or i == 11:
                    img_content = np.rot90(img_content, 3)
                imwrite(osp.join('images', 'resizedStory', '{}.jpg'.format(str(i))), img_content)
            else:
                continue
...
if __name__ == '__main__':
    vist_images_dir = '/vist/train//images'
    vist_annotations_dir = 'vist/annotations'
